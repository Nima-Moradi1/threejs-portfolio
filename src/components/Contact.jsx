  ...
  return (
    <div
      ...
      <motion.div
        ...
        <p
          className={`${styles.sectionSubText} text-2xl animate-character`}>
          Get in touch
        </p>
        <br />
        <h3 className={`${styles.sectionHeadText} animate-character`}>
          Contact.
        </h3>
        ...
        <form
          ...
          <button
            type="submit"
            className=" hover:scale-125 duration-300 bg-transparent py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-sm shadow-orange-500">
